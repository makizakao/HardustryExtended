...
import jp.makizakao.hardustryex.world.bar.PowerNodeBarManager;
import jp.makizakao.hardustryex.world.stat.IStatsManager;
import jp.makizakao.hardustryex.world.stat.PowerNodeStatsManager;
...
public class HardPowerNode extends PowerNode {
    ...
    protected IBarManager<HardPowerNode> barManager = new PowerNodeBarManager();
    protected IStatsManager<HardPowerNode> statsManager = new PowerNodeStatsManager();
    ...
    private HardPowerNode(Builder builder) {
        ...
        if(consumesPower) {
            ...
            consumePowerDynamic(this::getPowerLoss);
        }
    }

    public float getPowerLoss(Building building) {
        return building.power().graph.getPowerProduced() * powerConsumeMultiplier;
    }
